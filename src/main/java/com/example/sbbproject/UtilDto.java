...
public class UtilDto {
    public static List<QuestionDto> toQuestionDtoList(List<Question> questionList) {
        ...
        for(Question question : questionList) {
            questionDtoList.add(new QuestionDto(question.getId(), question.getSubject(), question.getContent(), question.getCreateDate(), question.getAuthor(), question.getVoter()));
        }
    ...
    public static List<AnswerDto> toAnswerDtoList(List<Answer> answerList) {
        ...
        for(Answer answer : answerList) {
            answerDtoList.add(new AnswerDto(answer.getId(), answer.getContent(), answer.getCreateDate(), answer.getAuthor(), answer.getVoter()));
        }

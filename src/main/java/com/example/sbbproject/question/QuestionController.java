...
public class QuestionController {
    ...
    @RequestMapping("/list")
    public String questionList(Model model, @RequestParam(value = "page", defaultValue = "0") int page, @RequestParam(value = "kw", defaultValue = "") String kw) {
    ...
    public String questionDelete(Principal principal, @PathVariable("questionId") Long questionId) {
        Question question = questionService.getQuestionById(questionId);
        if(!question.getAuthor().getUsername().equals(principal.getName())) {
    ...
    public String vote(@PathVariable("questionId") Long questionId, Principal principal) {
        Question question = questionService.getQuestionById(questionId);
        SiteUser siteUser = userService.getUser(principal.getName());

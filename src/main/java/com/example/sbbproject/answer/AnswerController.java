...
public class AnswerController {
    ...
    public String answerModify(@Valid AnswerForm answerForm, BindingResult bindingResult, @PathVariable("answerId") Long answerId, Principal principal) {
        ...
        return "redirect:/question/detail/%d#answer_%d".formatted(answer.getQuestion().getId(), answerId);
    }
    @PreAuthorize("isAuthenticated()")
    ...
    public String vote(@PathVariable("answerId") Long answerId, Principal principal) {
        Answer answer = answerService.getAnswerById(answerId);
        SiteUser siteUser = userService.getUser(principal.getName());
